...
![Session Papers](https://img.shields.io/badge/Session%20Papers-17-42BA16) ![Preprint Papers](https://img.shields.io/badge/Preprint%20Papers-0-b31b1b) ![Papers with Open Code](https://img.shields.io/badge/Papers%20with%20Open%20Code-0-1D7FBF)

<!-- example: | [PESTO: Pitch Estimation with Self-Supervised Transposition-Equivariant Objective](https://ismir2023program.ismir.net/poster_205.html) | [![GitHub](https://img.shields.io/github/stars/SonyCSLParis/pesto)](https://github.com/SonyCSLParis/pesto) | [![archives.ismir](https://img.shields.io/badge/pdf-ismir-2E6DA4.svg)](https://archives.ismir.net/ismir2023/paper/000063.pdf) <br /> [![arXiv](https://img.shields.io/badge/arXiv-2309.02265-b31b1b.svg)](https://arxiv.org/abs/2309.02265) <br /> [![Pdf](https://img.shields.io/badge/pdf-version-003B10.svg)](https://repositori.upf.edu/bitstream/handle/10230/58188/Plaja_ism_carn.pdf?sequence=1&isAllowed=y)| -->

| **Title** | **Repo** | **Paper** |
|-----------|:--------:|:---------:|
| [ST-ITO: Controlling audio effects for style transfer with inference-time optimization]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [ComposerX: Multi-Agent Music Generation with LLMs]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Do Music Generation Models Encode Music Theory?](https://ismir2023program.ismir.net/poster_179.html) | :heavy_minus_sign: | :heavy_minus_sign: |
| [PolySinger: Singing-Voice to Singing-Voice Translation from English to Japanese]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [On the validity of employing ChatGPT for distant reading of music similarity]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Sanidha: A Studio Quality Multi-Modal Dataset for Carnatic Music]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Between the AI and Me: Analysing Listeners' Perspectives on AI- and Human-Composed Progressive Metal Music]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Combining audio control and style transfer using latent diffusion]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Computational Analysis of Yaredawi YeZema Silt in Ethiopian Orthodox Tewahedo Church Chants]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Wagner Ring Dataset: A Complex Opera Scenario for Music Processing and Computational Musicology]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Lyrics Transcription for Humans: A Readability-Aware Benchmark]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [A Critical Survey of Research in Music Genre Recognition]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Content-based Controls for Music Large-scale Language Modeling]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Exploring the inner mechanisms of large generative music models]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Quantitative Analysis of Melodic Similarity in Music Copyright Infringement Cases]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [Robust lossy audio compression identification]() | :heavy_minus_sign: | :heavy_minus_sign: |
| [RNBert: Fine-Tuning a Masked Language Model for Roman Numeral Analysis]() | :heavy_minus_sign: | :heavy_minus_sign: |
